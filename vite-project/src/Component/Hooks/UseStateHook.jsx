...
function UseState(){
    ...
    return (
        <>
        <h1>UseState</h1>
        <p style={{color : color}} onMouseOver={mouseover}>lorembd fiohfds kjbfskd jnkn dkj jdfhkjadbfj jdfdfkjbgfkjbge djfnkjdbfdkjfgfkjnf 
        jndf kjndk jfbdk jfb d jfjdsnfdkjsfb </p>
